...
from nigbms.tasks import MinimizeTestFunctionTask, PETScLinearSystemTask, PyTorchLinearSystemTask, Task
...
class AbstractSolver(Module, ABC):
    ...
    def forward(self, tau: Task, theta: TensorDict) -> Tensor:
        ...
        Returns:
            Tensor: solver output
        """
        raise NotImplementedError


class TestFunctionSolver(AbstractSolver):
...
class OpenFOAMSolver(AbstractSolver):  # TODO: implement OpenFOAM solver
    def __init__(
        self,
        params_fix: dict,
        params_learn: dict,
