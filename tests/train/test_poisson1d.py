...
def test_main():
    with initialize(version_base="1.3", config_path="../configs/train"):
        ...
        cfg.wandb.project = "test_poisson1d"  # workaround for hydra error: raise ValueError("HydraConfig was not set"). see https://github.com/facebookresearch/hydra/issues/2017
